...
func testExec(t *testing.T, suite *KubeSuite, pinnedIP string, clientError string) {
	...
	role, err := types.NewRole("kubemaster", types.RoleImplSpec{
...
func testKubeTrustedClustersClientCert(t *testing.T, suite *KubeSuite) {
	...
	mainRole, err := types.NewRole("main-kube", types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins:     []string{username},
	...
	auxRole, err := types.NewRole("aux-kube", types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins: []string{username},
...
func testKubeJoin(t *testing.T, suite *KubeSuite) {
	...
	require.NoError(t, err)
	joinRole, err := types.NewRole("participant", types.RoleImplSpec{
		Allow: types.RoleConditions{
...
func testExecNoAuth(t *testing.T, suite *KubeSuite) {
	...
	kubeGroups := []string{kube.TestImpersonationGroup}
	kubeUsers := []string{"alice@example.com"}
	adminRole, err := types.NewRole("admin", types.RoleImplSpec{
		Allow: types.RoleConditions{
	...
	userUsername := "user"
	userRole, err := types.NewRole("userRole", types.RoleImplSpec{
		Allow: types.RoleConditions{
